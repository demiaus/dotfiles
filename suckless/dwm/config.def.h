...
static const Rule rules[] = {
    ...
    { "brave-browser-beta", NULL,     NULL,            1 << 1,    1,           0,          0,          0,         -1,      0          },
    ...
    { "KotatogramDesktop",  NULL,     NULL,            1 << 6,    1,           0,          0,          0,         -1,      0          },
    { "Anki",               "anki",   NULL,            1 << 7,    1,           0,          0,          0,         -1,      0          },
    { "Anki",               "anki",   "Browse",        1 << 7,    0,           1,          0,          0,         -1,      0          },
    { "Anki",               "anki",   "Add-ons",       1 << 7,    0,           1,          0,          0,         -1,      0          },
    { "Steam",              "Steam",  "Steam",         1 << 5,    1,           1,          0,          0,         -1,      0          },
    { "Steam",              "Steam",  "Steam - News",  1 << 5,    0,           1,          0,          0,         -1,      0          },
...
static const Key keys[] = {
    ...
    { MODKEY2|ControlMask|ShiftMask, XK_h,                     moveresizeedge,   {.v = "L"} },
    { MODKEY2|ControlMask|ShiftMask, XK_j,                     moveresizeedge,   {.v = "B"} },
    { MODKEY2|ControlMask|ShiftMask, XK_k,                     moveresizeedge,   {.v = "T"} },
    { MODKEY2|ControlMask|ShiftMask, XK_l,                     moveresizeedge,   {.v = "R"} },
